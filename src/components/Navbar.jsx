        ...
        <nav className="w-full h-[64%] bg-white absolute z-10 mt-20">
          <div className="px-28 py-10 flex flex-col gap-8">
            <div className="flex gap-4">
              <span>
                <img src="https://cdn.prod.website-files.com/639b3e775b326dcf7cea3e70/639b3e775b326d1404ea3edc_Stock.svg" alt="error" width="22px" />
              </span>
            ...
            <div className="p-2">
              <div className="grid grid-cols-4 gap-16">
                <div className="flex justify-center gap-4">
                  <div className="mt-1">
                    <img src="https://cdn.prod.website-files.com/639b3e775b326d0848ea3e74/63ff51f402d807110ce327e3_HELIX%20SVG%20ICON.svg" alt="error" width="22px" />
                  </div>
                ...
                <div className="flex justify-center gap-4">
                  <div className="mt-1">
                    <img src="https://cdn.prod.website-files.com/639b3e775b326d0848ea3e74/639b3e775b326d1743ea3e92_Demand%20Forcasting.svg" alt="error" width="22px" />
                  </div>
                  <div className="flex flex-col">
                ...
                <div className="flex justify-center gap-4">
                  <div className="mt-1">
                    <img src="https://cdn.prod.website-files.com/639b3e775b326d0848ea3e74/639b3e775b326d76a9ea3e90_Purchase%20Planning.svg" alt="error" width="22px" />
                  </div>
                  <div className="flex flex-col">
                ...
                <div className="flex justify-center gap-4">
                  <div className="mt-1">
                    <img src="https://cdn.prod.website-files.com/639b3e775b326d0848ea3e74/639b3e775b326de50dea3e93_Distribution%20Planning.svg" alt="error" width="22px" />
                  </div>
                  <div className="flex flex-col">
                ...
                <div className="flex justify-center gap-4">
                  <div className="mt-1">
                    <img src="https://cdn.prod.website-files.com/639b3e775b326d0848ea3e74/639b3e775b326da925ea3e91_Integrations.svg" alt="error" width="22px" />
                  </div>
                  <div className="flex flex-col">
                ...
                <div className="flex justify-center gap-4">
                  <div>
                    <img src="https://cdn.prod.website-files.com/639b3e775b326d0848ea3e74/643680ae1721eb351d815937_dashboard%20icon%20.svg" alt="error" width="22px" />
                  </div>
                  <div className="flex flex-col">
                ...
                <div className="flex justify-center gap-4">
                  <div className="mt-1">
                    <img src="https://cdn.prod.website-files.com/639b3e775b326d0848ea3e74/662a4722c49c3b0e91bbc19b_consensus.svg" alt="error" width="22px" />
                  </div>
                  <div className="flex flex-col">
        ...
        <nav className="w-80 right-[38%] h-[340px] bg-white absolute z-10 mt-20">
          <ul className="w-full h-full p-8 flex flex-col justify-center gap-10">
            <li className="flex justify-start items-center gap-5">
              <span>
                <img src="https://cdn.prod.website-files.com/639b3e775b326dcf7cea3e70/651d0a7855ca7d366a6cf4bc_ICONS.svg" alt="error" />
              </span>
              <span>Beauty and Personal Care</span>
            </li>
            <li className="flex justify-start items-center gap-5">
              <span>
                <img src="https://cdn.prod.website-files.com/639b3e775b326dcf7cea3e70/651d0c913aa58280f16babf9_dsfsa.svg" alt="error" />
              </span>
              <span>Quick Service Restaurants</span>
            </li>
            <li className="flex justify-start items-center gap-5">
              <span>
                <img src="https://cdn.prod.website-files.com/639b3e775b326dcf7cea3e70/651d0cb76f758e3b86ff173b_Group%202649.svg" alt="error" />
              </span>
              <span>Food and Beverages</span>
            </li>
            <li className="flex justify-start items-center gap-5">
              <span>
                <img src="https://cdn.prod.website-files.com/639b3e775b326dcf7cea3e70/651d0cd33aa58280f16bebe5_dfsa.svg" alt="error" />
              </span>
              <span>Apparel and Accessories</span>
            </li>
            <li className="flex justify-start items-center gap-5">
              <span>
                <img src="https://cdn.prod.website-files.com/639b3e775b326dcf7cea3e70/65d452b762741ee2943718b2_pharma%20icon%202.svg" alt="error" />
              </span>
